...
//    private String LOGOUT_BUTTON_ID = "logout_sidebar_link";
    private String LOGOUT_BUTTON_ID = "xpath=//a[3]";
    ...
    public WebElement logoutClick() { return SeleniumRunner.getSeleniumDriver().findElement(By.xpath(LOGOUT_BUTTON_ID)); }
}
