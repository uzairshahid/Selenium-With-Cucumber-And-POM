...
public class PageLogin {
    ...
    private String LOGOUT_BUTTON_XPATH = "//*[@id=\"logout_sidebar_link\"]";
    ...
    public WebElement logoutClick() { return SeleniumRunner.getSeleniumDriver().findElement(By.xpath(LOGOUT_BUTTON_XPATH)); }
}
